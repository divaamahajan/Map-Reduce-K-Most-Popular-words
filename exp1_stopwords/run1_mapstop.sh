...
-file exp1_stopwords/mapper_stopwords.py \
-mapper "python3 mapper_stopwords.py" \
-file exp1_stopwords/reducer.py \
-reducer "python3 reducer.py" \
-input /user/divyamahajan/MapReduce/input/data_16GB.txt \
-output /user/divyamahajan/MapReduce/output/topk_mapstop.txt
